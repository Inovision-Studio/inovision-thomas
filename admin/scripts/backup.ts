...
const TABLES = ["admin", "message", "application", "post", "galleryItem", "teamMember", "teamMessage", "client", "invoice", "ledger", "milestone", "clientMessage", "deployment", "agreement", "project", "projectUpdate", "audit", "auditItem", "mockup", "news", "setting"] as const;
