...
export const CLICK_LABELS: Record<string, string> = {
  "cta:shop": "Shop the catalog",
  "cta:directions": "Get directions",
  "cta:call": "Call",
  "bar:directions": "Directions (mobile bar)",
  "bar:shop": "Shop (mobile bar)",
  "bar:call": "Call (mobile bar)",
  "bar:text": "Text (mobile bar)",
  "bar:ai": "Ask AI (mobile bar)",
  "spin:open": "Spin to Win opened",
  "product:any": "Product cards",
};
